...
class OrderController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('backend.sales.all_orders.edit', compact('order', 'delivery_boys'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($order != null) {
            foreach ($order->orderDetails as $key => $orderDetail) {
                ...
                $orderDetail->price = $request->order_quantity * $orderDetail->product->unit_price;
                $orderDetail->quantity = $request->order_quantity;
                ...
                $order->grand_total = $subtotal + $tax + $shipping + $coupon;
