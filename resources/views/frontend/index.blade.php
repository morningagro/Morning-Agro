    ...
    <div class="home-banner-area mb-4">
        <div class="container-fluid px-0">
            <div class="row no-gutters position-relative">
                ...
                <div class="@if($num_todays_deal > 0) col-lg-10 @else col-lg-12 @endif px-0">
    ...
    <section class="mb-4">
        <div class="container">
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                <div class="d-flex mb-3 align-items-baseline border-bottom">
                    <h3 class="h5 fw-700 mb-0">
                        <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">{{ translate('আমাদের উপর আস্থা রেখেছেন ') }}</span>
                    </h3>
