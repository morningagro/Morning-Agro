...
<div class="card">
    <div class="card-header">
        <h1 class="h2 fs-16 mb-0">{{ translate('Edit Order Details') }}</h1>
    </div>
    <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                {{ csrf_field() }}
                                    <input class="form-control" name="order_quantity" id="order_quantity"
                                type="number" step="0.01" value="{{ $orderDetail->quantity }}">
                                <!-- <input class="form-control" name="order_product_price" id="order_product_price"
                                type="hidden" value="{{ $orderDetail->product }}"> -->
                                
                                <button  type="submit" class="btn btn-primary"><i class="las la-edit">Update Order</i></button>
        ...
        <div class="clearfix float-right">
            ...
            <div class="text-right no-print">
                <a href="{{ route('all_orders.index') }}" type="button" class="btn btn-success"><i class="las la-edit">Done</i></a>
            </div>
        </div>
